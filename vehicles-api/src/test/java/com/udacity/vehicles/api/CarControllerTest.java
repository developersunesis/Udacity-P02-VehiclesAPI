...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        JSONArray carList = new JSONObject(result)
                .getJSONObject("_embedded")
                .getJSONArray("carList");

        json.parse(carList.getJSONObject(0).toString())
                .assertThat()
                .isEqualToComparingFieldByFieldRecursively(car);
    }
    ...
    private Car getCar() {
        Car car = new Car();
        Location location= mapsClient.getAddress(new Location(40.730610, -73.935242));
        ...
        car.setPrice(priceClient.getPrice(1L));
        return car;
    }
}